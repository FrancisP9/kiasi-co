...
export function CinematicContact() {
  return (
    <section className="bg-background text-foreground py-32 px-6 relative z-10 border-t border-foreground/5 min-h-[80vh] flex flex-col justify-center">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        >
          <h2 className="text-xs font-light tracking-[0.3em] uppercase text-foreground/40 mb-12">
            Démarrer un projet
          </h2>
          
          <a 
            href="mailto:hello@kiasi.co" 
            className="group inline-flex items-center gap-4 md:gap-8 text-5xl md:text-7xl lg:text-8xl font-bold tracking-tighter hover:text-foreground/80 transition-colors duration-300"
          >
